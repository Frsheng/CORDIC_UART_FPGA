            ...
            case (sel)
                ...
                2'b1: begin
                    if (iter_cnt == 1'b0) begin
                        ...
                        x_out <= mult_tmp_x[47:16];
                        y_out <= mult_tmp_y[47:16];
                        if (vec_theta_adj == 2'b00) begin
                            z_out <= z_reg;
                        end else if (vec_theta_adj == 2'b01) begin
                            z_out <= z_reg + 32'h0001_9220;
                        end else if (vec_theta_adj == 2'b10) begin
                            z_out <= z_reg + 32'h0003_243F;
                        end
                    end
                end
                default: done <= 1'b0;
