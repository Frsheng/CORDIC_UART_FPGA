...
assign z_in = {rx_data_out[31], rx_data_out[15:0]};
assign tx_data_buffer = {x_out, y_out, z_out[16],15'b0 , z_out[15:0]}; // 需要根据实际数据格式调整
assign cor_start = rx_done; // 当接收完成时启动CORDIC计算
assign tx_start = cor_done; // 当CORDIC计算完成时启动发送
